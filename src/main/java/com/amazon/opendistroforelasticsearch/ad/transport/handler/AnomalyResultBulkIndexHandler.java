...
public class AnomalyResultBulkIndexHandler extends AnomalyIndexHandler<AnomalyResult> {
    ...
    public AnomalyResultBulkIndexHandler(
        ...
        super(client, settings, threadPool, indexName, createIndex, indexExists, fixedDoc, clientUtil, indexUtils, clusterService);
        this.anomalyDetectionIndices = anomalyDetectionIndices;
    }

    public void bulkIndexAnomalyResult(List<AnomalyResult> anomalyResults, ActionListener<BulkResponse> listener) {
        try {
            if (super.indexUtils.checkIndicesBlocked(clusterService.state(), ClusterBlockLevel.WRITE, AnomalyResult.ANOMALY_RESULT_INDEX)) {
