...
public class BatchAnomalyResultTransportAction extends HandledTransportAction<ActionRequest, BatchAnomalyResultResponse> {

    // TODO: unify the logger name, we have LOG, log, logger currently
    private static final Logger LOG = LogManager.getLogger(BatchAnomalyResultTransportAction.class);
    ...
    @Inject
    public BatchAnomalyResultTransportAction(
        ...
        super(BatchAnomalyResultAction.NAME, transportService, actionFilters, BatchAnomalyResultRequest::new);
        this.client = client;
    ...
    @Override
    protected void doExecute(Task task, ActionRequest actionRequest, ActionListener<BatchAnomalyResultResponse> actionListener) {
