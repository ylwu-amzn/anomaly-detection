 ...
 */
public class ExecutingTaskSupplier implements Supplier<Integer> {
    protected AnomalyDetectionTaskManager taskManager;

    /**
     * Constructor
     */
    public ExecutingTaskSupplier(AnomalyDetectionTaskManager taskManager) {
